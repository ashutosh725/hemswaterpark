...
const Newsletter = () => {
  return (
    <div  className="  bg-cover bg-center h-[400px] flex justify-center items-center " style={{ backgroundImage: `url(${Banner2.src})` }}>
...
<div className='flex flex-col  justify-center items-center gap-7'>
    ...
    <div className='flex justify-center items-center gap-5'>
        <input type='text' placeholder='Your Email Address ' className='md:w-[500px] w-[200px] py-5 outline-none px-5'/>
